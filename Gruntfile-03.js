module.exports = function(grunt) {
 ...
 /*    css: {
        files: ['assets/styles/sass/*.scss','assets/styles/*.css' ],
        tasks: ['sass'],
        options: {
            spawn: false,
        },
    ...
    cssmin: {
        css:{ 
            files: {
              'assets/styles/build/global.min.css': ['assets/styles/build/global.css', ]
            },
        },
    },*/ 
...
/*    copy: {
    dist: {
        files: [{
            src: [
                'assets/styles/build/global.min.css',
                'build/fonts/**'
            ]
        }]
    }
